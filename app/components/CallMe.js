    ...
    <div className="font-[family-name:var(--font-poppins-sans)] font-semibold text-gray-300 text-center flex flex-row items-center justify-center">
      <div className="md:mx-20 mx-8">
        <div className="md:text-left text-center">
          ...
          <div
            className="text-justify font-medium md:text-lg text-base flex justify-start mb-4 h-80 overflow-auto"
          ...
          >
            ...
            I&apos;ve learned on my projects in the class, therefore, I&apos;ve
            been a Lecturer and speaker in some Colleges. I&apos;m so delighted
            when sharing new knowledge I&apos;ve learnt and from my research.
            I&apos;ve worked with big teams, small teams, and individuals as
            well. Despite occour different ideas and generations, and with their
            respective issues, I can address them nicely. I&apos;ve also worked
            with methodologies such as Agile, which involves frameworks such as
            Scrum and Kanban to manage projects, and with tools such as Pivotal
            Tracker, Jira, and Trello. One of my positive abilities is that I
            can catch up and quickly learn and adapt to all conditions and tech.
            That&apos;s it about me, and I&apos;m open to work for companies as
            a Software Engineer, Full-Stack Developer, Data Analyst, and Data
